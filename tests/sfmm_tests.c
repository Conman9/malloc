...
Test(sfmm_student_suite, lots_of_int, .timeout = TEST_TIMEOUT) {
	sf_errno = 0;
	int *a = sf_malloc(sizeof(int));
	int *b = sf_malloc(sizeof(int));
	int *c = sf_malloc(sizeof(int));
	int *d = sf_malloc(sizeof(int));
	int *e = sf_malloc(sizeof(int));
	int *f = sf_malloc(sizeof(int));

	cr_assert_not_null(a, "a is NULL!");
	cr_assert_not_null(b, "b is NULL!");
	cr_assert_not_null(c, "c is NULL!");
	cr_assert_not_null(d, "d is NULL!");
	cr_assert_not_null(e, "e is NULL!");
	cr_assert_not_null(f, "f is NULL!");
	...
	*f = 3249324;
	...
	cr_assert(*a == 43124, "sf_malloc failed to give proper space for an int!");
	cr_assert(*b == 2344, "sf_malloc failed to give proper space for an int!");
	cr_assert(*c == 3124, "sf_malloc failed to give proper space for an int!");
	cr_assert(*d == 2314, "sf_malloc failed to give proper space for an int!");
	cr_assert(*e == 3432, "sf_malloc failed to give proper space for an int!");
	cr_assert(*f == 3249324, "sf_malloc failed to give proper space for an int!");
...
//}
Test(sfmm_student_suite, malloc_splinter_check, .timeout = TEST_TIMEOUT) {
	sf_errno = 0;
	...
	*x = 234;
	...
	cr_assert(*x == 234, "sf_malloc failed to give proper space for an int!");
	cr_assert(*y == 1, "sf_malloc failed to give proper space for an int!");
...
Test(sfmm_student_suite, big_numbers, .timeout = TEST_TIMEOUT) {
	sf_errno = 0;
